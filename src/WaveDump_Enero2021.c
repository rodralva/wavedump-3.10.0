...
#define WaveDump_Release        "3.10.0 Ciemat 2.0"
#define WaveDump_Release_Date   "October 2019"
#define DBG_TIME
...
int WriteOutputFiles(WaveDumpConfig_t *WDcfg, WaveDumpRun_t *WDrun, CAEN_DGTZ_EventInfo_t *EventInfo, void *Event, uint16_t ExtendedTT, int Nf, int NewFile)
{
    int ch, j, ns;
    CAEN_DGTZ_UINT16_EVENT_t  *Event16 = NULL;
    CAEN_DGTZ_UINT8_EVENT_t   *Event8 = NULL;
...
InterruptTimeout:
        ...
        for(i = 0; i < (int)NumEvents; i++) {
            ...
            ExtendedTT = (uint16_t)MyEventHeader[6] * 256 + MyEventHeader[5];
